...
struct ctp_queue;
typedef struct ctp_queue ctp_queue_t;

/**
 * @brief Function to create a thread safe queue
 */
ctp_queue_t* ctp_queue_create(int* ec);
 ...
 */
void** ctp_queue_destroy(ctp_queue_t* pque, size_t* left_node_size, int* ec);

void ctp_queue_push(ctp_queue_t* pque, void* value, int* ec);
void* ctp_queue_try_pop(ctp_queue_t* pque, int* ec);
void* ctp_queue_wait_pop(ctp_queue_t* pque, int* ec);

/**
 * @brief only serves as a hint during concurrent operations
 */
bool ctp_queue_empty(ctp_queue_t* pque, int* ec);
 ...
 */
void ctp_queue_all_wait_terminate(ctp_queue_t* pque, int* ec);

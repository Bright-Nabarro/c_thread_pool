...
typedef struct ctp_logger_context ctp_logger_context_t;

void ctp_logger_config_default(ctp_logger_config_t* config);
ctp_logger_context_t* ctp_logger_init(const ctp_logger_config_t* config,
										  int* ec);
...
int ctp_logger_log(ctp_logger_context_t* context, ctp_log_level_t level,
					const char* fmt, ...);
void ctp_logger_close(ctp_logger_context_t* context, int* ec);
